 ...
 */
delete_site_transient( 'hpgp_github_release_reason' );
delete_site_transient( 'hpgp_github_release_rate_limit' );

if ( function_exists( 'as_unschedule_all_actions' ) ) {
	as_unschedule_all_actions( 'hpgp_github_release_refresh', [], 'hivepress' );
	as_unschedule_all_actions( 'hpgp_github_release_refresh' );
}

wp_clear_scheduled_hook( 'hpgp_github_release_refresh' );
